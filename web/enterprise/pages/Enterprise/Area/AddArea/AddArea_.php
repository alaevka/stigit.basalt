...
<table width="100%" height="100%" border="0" cellpadding="10" cellspacing="0" id="bgTable">
      ...
      <tr class="tdInt">
        <td height="10px">
		   <div class="title"><a href="../ViewArea/ViewArea.php">
		   Административные единицы </a> 
		   » Добавление административной единицы  </div>
		...
		<table class="borderList" width="100%" border="0" cellspacing="1" cellpadding="2">
          <tr class="headSubList">
            ...
            <tr class="rowList item">
              ...
              <td ><input name="name_area" type="text" class="textField" id="name_area" size="40"></td>
            </tr>
            <tr class="rowList item">
              <td >Тип</td>
              <td><input name="type_area" type="text" class="textField" id="type_area" size="40"></td>
            </tr>
