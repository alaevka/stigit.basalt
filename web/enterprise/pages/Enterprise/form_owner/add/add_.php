...
<table width="100%" height="100%" border="0" cellpadding="10" cellspacing="0" id="bgTable">
      ...
      <tr class="tdInt">
        <td height="10px">
		   <div class="title"><a href="../View/View.php">
		   Формы собственности </a> 
		   » Добавить форму собственности  </div>
		...
		<table class="borderList" width="100%" border="0" cellspacing="1" cellpadding="2">
          <tr class="headSubList">
            ...
            <tr class="rowList item">
              <td width="200" nowrap >Обозначение</td>
              <td><input name="name_form_small" type="text" class="textField" id="name_form_small" size="40"></td>
            </tr>
            <tr class="rowList item">
              <td>Наименование</td>
              <td><input name="name_form" type="text" class="textField" id="name_form" size="40"></td>
            </tr>

            <tr class="rowList item">
              <td >Действует</td>
              <td>
              	<input name="action" type="checkbox" id="action" value="1">
              </td>
            </tr>
			<tr class="rowList item">
